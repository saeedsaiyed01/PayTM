...
export default function CurrencyTransfer() {
  return (
    <div className="w-full max-w-sm mx-auto p-6 min-h-[300px] flex flex-col justify-center bg-zinc-900 dark:bg-white border border-zinc-800 dark:border-zinc-200 backdrop-blur-sm rounded-lg">
